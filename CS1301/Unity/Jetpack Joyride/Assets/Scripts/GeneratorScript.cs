...
public class GeneratorScript : MonoBehaviour {
	...
	void AddObject(float lastObjectX) {
		...
		float rotation = Random.Range( this.objectsMinRotation, this.objectsMaxRotation );
	...
	void GenerateObjectsIfRequired () {
		float playerX = transform.position.x;
		float removeObjectsX = playerX - this.screenWidthInPoints;
		float addObjectX = playerX + this.screenWidthInPoints;
